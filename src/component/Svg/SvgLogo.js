...
const SvgLogo = () => {
    return (
        <svg version={1} viewBox="0 0 209.1 39.7">
            ...
            <path fill="#5fe084" d="M17.8 8.6c-3.7 0-7.5 2-8.5 6.7h3.3a5.6 5.6 0 0 1 5.2-3.8 6.2 6.2 0 0 1 2.2.5 1.9 1.9 0 0 0 2.3-.4l1-1.3a8.9 8.9 0 0 0-5.5-1.7zM9.3 19.3V28a3.3 3.3 0 0 0 3.3 3.3v-12zm13.7 0v11.9a3.3 3.3 0 0 0 3.3-3.3v-8.6zm-6.7 3v8.9h3.2v-9h-3.2z" />
        </svg>
    );
};
